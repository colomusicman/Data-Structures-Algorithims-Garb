...
// Task 2a - Implement quick-sort

/**
 * Split the vector, and sort bi-directionally
 *
...
// Task1 1a Implement the selection sort & sort by title
...
int main(int argc, char* argv[]) {
    ...
    while (choice != 9) {
        ...
        case 2:
            ...
            // Task 1b - Invoke the selection sort and report timing results
        case 3:
            // Initialize a timer variable before loading bids
            ticks = clock();
            ...
            // Call the selection sort, and output elapsed time.
            ticks = clock() - ticks;
            cout << "time: " << ticks << " clock ticks" << endl;
            cout << "time: " << ticks * 1.0 / CLOCKS_PER_SEC << " seconds" << endl;
            ...
            // Task 2b - Call the quick sort and output elapsed time.
        case 4:
            // Initialize a timer variable before loading bids
            ticks = clock();
